module github.com/gagliardetto/codemill
...
require (
	...
	github.com/gagliardetto/codebox v0.0.0-20201028125312-a6b9ab5964bb
	github.com/gagliardetto/feparser v0.0.0-20201028125514-646b648536f9
